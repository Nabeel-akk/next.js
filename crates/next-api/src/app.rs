...
impl AppEndpoint {
    ...
    async fn output(self: Vc<Self>) -> Result<Vc<AppEndpointOutput>> {
        ...
        // The server chunking context the RSC entry is chunked with. Also used by
        // the client-reference manifest to compute `rscModuleMapping` ids.
        ...
        if emit_rsc_manifests {
            let entry_manifest = ResolvedVc::upcast(
                ClientReferenceManifest {
                    ...
                    rsc_chunking_context: server_chunking_context,
